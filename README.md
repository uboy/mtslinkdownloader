...
- Блок чата отрисовывается шире карточек камер и по высоте равен двум карточкам камеры для лучшей читаемости текста.
- Ширина блока чата увеличена до `1.5x` относительно базовой ширины правой панели.
